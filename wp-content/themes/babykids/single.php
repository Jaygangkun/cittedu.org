        ...
        while(have_posts()) : the_post(); ?>
            ...
            <div class="nicdark_section">
                ...
                <?php $args = array(
                    ...
                    'nextpagelink'     => esc_html__('Next page', 'babykids'),
                    'previouspagelink' => esc_html__('Previous page', 'babykids'),
                    'pagelink'         => '%',
                    'echo'             => 1
                ); ?>
                ...
                <?php 
                    esc_html_e('Categories : ','babykids');
                    the_category();
                ?>
                </div>
                <!--END categories-->
